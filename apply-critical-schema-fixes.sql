-- Direct SQL script to apply critical schema fixes to Supabase database
-- This script adds missing columns and tables to resolve 400/404 errors

-- =============================================================================
-- 1. FIX SAVINGS_GOALS TABLE - ADD MISSING COLUMNS
-- =============================================================================

-- Add missing columns to savings_goals table
...
-- =============================================================================
-- 2. FIX FINANCIAL_INSIGHTS TABLE - ADD MISSING COLUMNS
-- =============================================================================
...
-- =============================================================================
-- 3. CREATE USER_INSIGHT_PREFERENCES TABLE
-- =============================================================================
...
-- Function to calculate next generation due date (simplified version)
...
SELECT 'VALIDATION: Checking savings_goals columns' as check_type;
...
SELECT 'VALIDATION: Checking financial_insights columns' as check_type;
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_schema = 'public' 
...
SELECT 'VALIDATION: Checking user_insight_preferences table' as check_type;
SELECT 
    CASE 
...
SELECT '✅ CRITICAL SCHEMA FIXES APPLIED SUCCESSFULLY!' as result;
